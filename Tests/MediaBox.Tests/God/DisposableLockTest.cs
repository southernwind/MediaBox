...
namespace SandBeige.MediaBox.Tests.God {
	...
	internal class DisposableLockTest {
		...
		public async Task 読み取り専用ロックによる同時実行() {
			...
			result.Is("3-1", "2-1", "1-1", "1-2", "3-2", "2-2");
		}
		...
		public async Task 書き込みロックによる排他制御() {
			...
			result.Is("3-1", "3-2", "2-1", "2-2", "1-1", "1-2");
		}
...
#pragma warning disable 612
			Assert.Throws<NotSupportedException>(dl.EnterReadLock);
#pragma warning restore 612
		...
		public void EnterWriteLock() {
			using var dl = new DisposableLock(LockRecursionPolicy.SupportsRecursion);
#pragma warning disable 612
			Assert.Throws<NotSupportedException>(dl.EnterWriteLock);
#pragma warning restore 612
		}
